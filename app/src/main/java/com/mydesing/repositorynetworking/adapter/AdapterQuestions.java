package com.mydesing.repositorynetworking.adapter;
...
import com.mydesing.repositorynetworking.R;
...
public class AdapterQuestions extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void set_Up_QuestionTwoHolder(RecyclerView.ViewHolder holder){
        ...
        radioButton_one.setText(correct_Answer);
        radioButton_two.setText(wrong_Answers.get(0));
    ...
    public void set_Up_QuestionFourHolder(RecyclerView.ViewHolder holder){
        ...
        radioButton_one.setText(correct_Answer);
        radioButton_two.setText(wrong_Answers.get(0));
        radioButton_three.setText(wrong_Answers.get(1));
        radioButton_four.setText(wrong_Answers.get(2));
